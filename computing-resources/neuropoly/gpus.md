...
For lesion segmentation (MS, SCI) tasks, you can compute ANIMA metrics, see script [here](https://github.com/ivadomed/model_seg_sci/blob/main/utils/compute_test_metrics_anima.py).
